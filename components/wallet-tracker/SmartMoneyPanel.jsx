    ...
    <div style={{ marginTop: '1rem', background: C.panelBg, backdropFilter: 'blur(12px)', border: `1px solid ${C.border}`, borderRadius: '8px', padding: '1rem 1.25rem', transition: 'border-color 0.2s' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
          ...
          <span style={{ fontFamily: FONT_MONO, fontSize: '0.72rem', fontWeight: 700, color: C.cyan, letterSpacing: '0.8px', textTransform: 'uppercase' }}>Smart Money</span>
        </div>
        <span style={{ fontSize: '0.6rem', fontFamily: FONT_MONO, color: C.muted, background: 'rgba(0,229,255,0.04)', padding: '0.1rem 0.4rem', borderRadius: '3px', border: `1px solid ${C.border}` }}>LIVE</span>
      </div>

      {/* Summary */}
      <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '0.75rem', fontSize: '0.65rem', fontFamily: FONT_MONO }}>
          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                <span style={{ fontSize: '0.72rem', fontWeight: 700, color: C.text, fontFamily: FONT_MONO }}>{t.symbol}</span>
                {t.signal !== 'aligned' && (
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                ...
                <span style={{ fontSize: '0.62rem', fontWeight: 600, color: smColor, fontFamily: FONT_MONO, minWidth: '28px', textAlign: 'right' }}>{t.smartMoney.longPct}%</span>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                ...
                <span style={{ fontSize: '0.62rem', fontWeight: 600, color: rtColor, fontFamily: FONT_MONO, minWidth: '28px', textAlign: 'right' }}>{t.retail.longPct}%</span>
              </div>

              {/* Divergence */}
              <span style={{ fontSize: '0.65rem', fontWeight: 700, color: divColor, fontFamily: FONT_MONO, textAlign: 'right' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '50px 1fr 1fr 45px', gap: '0.4rem', marginTop: '0.5rem', paddingTop: '0.4rem', borderTop: `1px solid ${C.border}` }}>
        <span />
        <span style={{ fontSize: '0.55rem', color: C.muted, fontFamily: FONT_MONO, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Top 20%</span>
        <span style={{ fontSize: '0.55rem', color: C.muted, fontFamily: FONT_MONO, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Retail</span>
        <span style={{ fontSize: '0.55rem', color: C.muted, fontFamily: FONT_MONO, textTransform: 'uppercase', letterSpacing: '0.5px', textAlign: 'right' }}>Gap</span>
      </div>
    </div>
  )
}
